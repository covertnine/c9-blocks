...
const KeyframeStepper = props => {
	...
	return ( <
		...
		<
		div className = "block-editor-image-size-control__row c9-key-stepper" >
		<
		StyledButtonGroup aria-label = {
			label
		} > {
