import Icon from "./page-icons/launch-release.svg";

export default {
	icon: Icon,
	type: "consideration",
	title: "Landing Page Launch Release",
	...
	<div class="wp-block-button aligncenter is-style-default"><a class="wp-block-button__link has-text-color has-very-light-gray-color" href="#">stream NOW</a></div>
	<!-- /wp:button --></div></div>
	<!-- /wp:c9-blocks/column --></div></div>
	<!-- /wp:c9-blocks/column-container --></div>
	<!-- /wp:c9-blocks/grid -->
	
	<!-- wp:c9-blocks/grid {"instanceId":1,"minScreenHeight":10,"containerMargin":{"linked":true,"unit":"px","top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"},"containerPadding":{"linked":true,"top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"}} -->
	<div class="c9-grid my-5 c9-scroll" style="min-height:10vh"><!-- wp:c9-blocks/column-container {"columns":3,"columnsGap":4,"layout":"c9-3-col-equal","overlayHue":"#313131","overlayOpacity":10,"containerMargin":{"linked":false,"top":"5","bottom":"5","left":"-1","right":"-1","icon":"editor-unlink"},"containerPadding":{"linked":true,"top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"}} -->
	<div class="container c9-column-container p-5 my-5 c9-scroll c9-layout-columns-3 c9-3-col-equal"><div class="c9-overlay-container" style="background-color:rgba(49,49,49,1);mix-blend-mode:overlay"></div><div class="c9-layout-column-wrap c9-block-layout-column-gap-4 c9-is-responsive-column"><!-- wp:c9-blocks/column {"verticalAlign":"top"} -->
	<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-top"><div class="c9-column-innner"><!-- wp:image {"id":472,"width":305,"height":305,"className":"img-fluid"} -->
	<figure class="wp-block-image is-resized img-fluid"><img src="http://cortex.covertnine.com/wp-content/uploads/2019/10/fake-album-3-768x768.jpg" alt="" class="wp-image-472" width="305" height="305"/></figure>
	<!-- /wp:image -->
	...
	<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-top"><div class="c9-column-innner"><!-- wp:image {"id":471,"width":305,"height":305,"className":"img-fluid"} -->
	<figure class="wp-block-image is-resized img-fluid"><img src="http://cortex.covertnine.com/wp-content/uploads/2019/10/fake-album-2-768x768.jpg" alt="" class="wp-image-471" width="305" height="305"/></figure>
	<!-- /wp:image -->
	...
	<!-- wp:c9-blocks/column {"verticalAlign":"top"} -->
	<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-top"><div class="c9-column-innner"><!-- wp:image {"id":470,"width":304,"height":304,"className":"img-fluid"} -->
	<figure class="wp-block-image is-resized img-fluid"><img src="http://cortex.covertnine.com/wp-content/uploads/2019/10/fake-album-1-768x768.jpg" alt="" class="wp-image-470" width="304" height="304"/></figure>
	<!-- /wp:image -->
	...
	<!-- wp:c9-blocks/grid {"instanceId":4,"containerImgURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/gutenberg-event-page-template-band.jpg","overlayHue":"#cf2e2e","blendMode":"multiply","minScreenHeight":85,"containerMargin":{"linked":true,"unit":"px","top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"},"focalPoint":{"x":0.4700460829493088,"y":0.3541666666666667}} -->
	...
	<!-- wp:c9-blocks/heading {"heading":"$19 / ADVANCED","tagLevel":6,"textColor":"#313131","textAlign":"center","overrideStyle":true} -->
	...
	<!-- wp:button {"customBackgroundColor":"#27b066","align":"center","className":"is-style-squared"} -->
	<div class="wp-block-button aligncenter is-style-squared"><a class="wp-block-button__link has-background" href="#" style="background-color:#27b066">Get Tickets</a></div>
	<!-- /wp:button --></div></div>
	<!-- /wp:c9-blocks/column --></div></div>
	<!-- /wp:c9-blocks/column-container --></div>
	<!-- /wp:c9-blocks/grid -->
	...
	<!-- wp:c9-blocks/heading {"heading":"$19 / ADVANCED","tagLevel":5,"textAlign":"center","overrideStyle":true} -->
