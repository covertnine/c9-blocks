...
export default {
	...
	<div class="c9-block-layout-column c9-column text-left"><div class="c9-column-innner"><!-- wp:c9-blocks/heading {"heading":"Get in touch","subheading":"We're here to help","addSubheading":true,"type":"c9-txl display-","textColor":"#ffffff","textAlign":"center"} -->
	<div class="section-heading c9-heading text-center"><h1 class="c9-txl display-1" style="color:#ffffff">Get in touch</h1><div class="c9-txl display-1"><small class="text-muted">&nbsp;We're here to help</small></div></div>
	...
	<div class="c9-grid p-5 c9-scroll" style="min-height:20vh"><!-- wp:c9-blocks/column-container {"columns":2,"columnsGap":6,"layout":"c9-2-col-wideleft","containerMargin":{"linked":false,"top":"5","bottom":"-1","left":"-1","right":"-1","icon":"editor-unlink"},"containerPadding":{"linked":true,"top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"}} -->
	...
	<div class="c9-block-layout-column c9-column text-left"><div class="c9-column-innner"><!-- wp:c9-blocks/heading {"heading":"Email Us Directly","subheading":"Response time 24/7","addSubheading":true,"tagLevel":3} -->
	...
	<div class="wp-block-button aligncenter"><a class="wp-block-button__link" href="#">live chat now</a></div>
	<!-- /wp:button -->
	...
	<p style="text-align:center"><strong>Headquarters</strong> (Not the bar)<br>100 N. Main St.<br>Suite 200<br>Chicago, IL</p>
	<!-- /wp:paragraph --></div></div>
	<!-- /wp:c9-blocks/column --></div></div>
	<!-- /wp:c9-blocks/column-container --></div>
	<!-- /wp:c9-blocks/grid -->`
