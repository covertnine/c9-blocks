export default {
	...
	<div class="c9-grid p-5 p-3 c9-scroll" style="min-height:50vh;background-color:rgba(23,23,23,1)"><!-- wp:c9-blocks/column-container {"align":"narrow","columns":2,"layout":"c9-2-col-wideleft","containerWidth":"container-narrow","verticalAlign":"bottom","minScreenHeight":0} -->
	...
	<!-- wp:c9-blocks/heading {"heading":"Mutually Making Weird Words Meaningless","tagLevel":2,"displayLevel":"3","type":"c9-sh subhead-h","textColor":"#b0b0b0","overrideStyle":true} -->
	<div class="section-heading c9-heading text-left"><h2 class="c9-sh subhead-h3" style="color:#b0b0b0">Mutually Making Weird Words Meaningless</h2></div>
	<!-- /wp:c9-blocks/heading -->
	
	<!-- wp:paragraph {"style":{"color":{"text":"#ffffff"},"typography":{"fontSize":10}}} -->
	<p class="has-text-color" style="color:#ffffff;font-size:10px">Click the outer edges of the container to change the background color, image, or video! Once you highlight the <strong>C9 Grid block</strong>, click on it, and you can make changes under <strong>Background Settings</strong> in the sidebar from the WordPress edit screen.</p>
	<!-- /wp:paragraph --></div></div>
	<!-- /wp:c9-blocks/column -->
	
	<!-- wp:c9-blocks/column {"verticalAlign":"center"} -->
	<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-center"><div class="c9-column-innner"><!-- wp:image {"align":"center","id":2452,"width":128,"height":128,"sizeSlug":"large"} -->
	<figure class="wp-block-image aligncenter size-large is-resized"><img src="https://c9.covertnine.com/wp-content/uploads/2020/04/c9-apple-touch-logo-512.png" alt="Logo" class="wp-image-2452" width="128" height="128"/></figure>
	<!-- /wp:image --></div></div>
	...
	<div class="c9-grid p-5 p-3 c9-fixed c9-grid-has-background" style="min-height:90vh;background-color:rgba(49,49,49,1);--mobile-height:auto;--mobile-width:100%"><!-- wp:c9-blocks/column-container {"columns":2,"columnsGap":10,"layout":"c9-2-col-wideleft","minScreenHeight":0} -->
	...
	<!-- wp:c9-blocks/heading {"heading":"Page Secondary Headline","subheading":"Landing Page","displayLevel":"5","type":"c9-txl display-","textColor":"#eeeeee","weight":"light","overrideStyle":true} -->
	<div class="section-heading c9-heading text-left"><h1 class="c9-txl display-5 font-weight-light" style="color:#eeeeee">Page Secondary Headline</h1></div>
	<!-- /wp:c9-blocks/heading -->
	
	<!-- wp:c9-blocks/heading {"heading":"Set the Background image to be fixed on the sidebar \u003e Background Settings panel to have the photo fixed in place while scrolling like we've done in this section.","tagLevel":6,"type":"c9-sh subhead-h","textColor":"#b2b2b2","weight":"light"} -->
	<div class="section-heading c9-heading text-left"><h6 class="c9-sh font-weight-light" style="color:#b2b2b2">Set the Background image to be fixed on the sidebar > Background Settings panel to have the photo fixed in place while scrolling like we've done in this section.</h6></div>
	<!-- /wp:c9-blocks/heading -->
	...
	<div class="c9-grid p-5 p-3 my-5 c9-scroll" style="min-height:20vh"><!-- wp:c9-blocks/column-container {"columns":1,"layout":"one-column","overlayHue":"#f8f8f8","minScreenHeight":0,"animateVal":"fadeLeft","animateDelay":686,"animateScrub":true,"animateStart":"0px 100%","animateEnd":"138px 50%","animateCustom":{"before":{"x":-300},"after":{}}} -->
	...
	<div style="text-align:left" class="c9-cta c9-block-cta container p-5"><div class="row"><div class="c9-cta-content col-12 col-md-8"><div class="c9-cta-text c9-sh" style="font-size:1.6rem"><p>Sign up today for a 30% off annual discount and waiving all fees, today!</p></div></div><div class="c9-cta-button col-12 col-md-4"><a href="#" target="_self" rel="noopener noreferrer" class="wp-block-button__link c9-button-shape-square c9-button-size-extralarge" style="color:#ffffff">Sign up</a></div></div></div>
	<!-- /wp:c9-blocks/cta --></div></div>
	<!-- /wp:c9-blocks/column --></div></div>
	<!-- /wp:c9-blocks/column-container -->
	
	<!-- wp:c9-blocks/column-container {"align":"narrow","columns":1,"layout":"one-column","containerWidth":"container-narrow","minScreenHeight":0} -->
	...
	<div id="accordion-0" class="c9-toggles accordion"><!-- wp:c9-blocks/toggles-toggle {"toggleNumber":1,"id":0} -->
	...
	<div class="c9-toggles-toggle"><div class="c9-toggles-item-heading" id="c9-toggles-heading4-0" data-toggle="collapse" data-target="#c9-toggles-collapse4-0"><div class="mb-0"><span class="c9-toggles-toggle-label"><strong>4. </strong>What does an image carousel look like?</span><span class="c9-toggles-item-collapse"><span class="fas fa-angle-right"></span></span></div></div><div class="c9-toggles-item-content collapse" id="c9-toggles-collapse4-0" data-parent="#accordion-0"><div><!-- wp:c9-blocks/image-carousel {"instanceId":0,"url":["https://c9.covertnine.com/wp-content/uploads/2020/09/20190622-disney-alaska-vacation-66-2-1024x683.jpg","https://c9.covertnine.com/wp-content/uploads/2020/09/20190619-disney-alaska-vacation-171-2-1024x683.jpg","https://c9.covertnine.com/wp-content/uploads/2020/09/20190621-disney-alaska-vacation-207-2-1024x683.jpg"],"id":[2805,2791,2803],"captionTitle":[null,"Slide Caption",null],"captionContent":[null,"Slide description or photo description.",null],"isResponsive":true,"slideMaxHeight":476,"className":"container"} -->
	<div id="c9-image-carousel-indicator-0" class="c9-image-carousel container carousel slide container" data-ride="carousel" data-interval="5000" data-wrap="true" style="min-height:476px"><ol class="carousel-indicators"><li data-target="#c9-image-carousel-indicator-0" data-slide-to="0" class="active"></li><li data-target="#c9-image-carousel-indicator-0" data-slide-to="1"></li><li data-target="#c9-image-carousel-indicator-0" data-slide-to="2"></li></ol><div class="carousel-inner"><div class="carousel-item active"><img src="https://c9.covertnine.com/wp-content/uploads/2020/09/20190622-disney-alaska-vacation-66-2-1024x683.jpg" class="d-block w-100 wp-image-2805"/></div><div class="carousel-item"><img src="https://c9.covertnine.com/wp-content/uploads/2020/09/20190619-disney-alaska-vacation-171-2-1024x683.jpg" class="d-block w-100 wp-image-2791"/><div class="carousel-caption d-none d-md-block"><h5>Slide Caption</h5><p>Slide description or photo description.</p></div></div><div class="carousel-item"><img src="https://c9.covertnine.com/wp-content/uploads/2020/09/20190621-disney-alaska-vacation-207-2-1024x683.jpg" class="d-block w-100 wp-image-2803"/></div></div><a class="carousel-control-prev" href="#c9-image-carousel-indicator-0" role="button" data-slide="prev"><span class="carousel-control-prev-icon" aria-hidden="true"></span><span class="sr-only">Previous</span></a><a class="carousel-control-next" href="#c9-image-carousel-indicator-0" role="button" data-slide="next"><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="sr-only">Next</span></a></div>
	...
	<div class="c9-grid p-5 p-3 c9-fixed c9-grid-has-background" style="min-height:75vh"><!-- wp:c9-blocks/column-container {"columns":2,"layout":"c9-2-col-wideleft","verticalAlign":"bottom","minScreenHeight":0} -->
	...
	<!-- wp:c9-blocks/heading {"heading":"Leadership Team","displayLevel":"3","type":"c9-txl display-","textColor":"#ffffff","overrideStyle":true} -->
	<div class="section-heading c9-heading text-left"><h1 class="c9-txl display-3" style="color:#ffffff">Leadership Team</h1></div>
	<!-- /wp:c9-blocks/heading -->
	
	<!-- wp:c9-blocks/heading {"heading":"Co-Founder and Chief Financial Officer","tagLevel":4,"type":"c9-sh subhead-h","textColor":"#ffffff","weight":"light","overrideStyle":true} -->
	<div class="section-heading c9-heading text-left"><h4 class="c9-sh subhead-h4 font-weight-light" style="color:#ffffff">Co-Founder and Chief Financial Officer</h4></div>
	<!-- /wp:c9-blocks/heading -->
	
	<!-- wp:c9-blocks/heading {"heading":"Highlight the text in the WordPress admin to change quotes, or click on the outer edge C9 Grid block to change the background image or color overlay settings!","tagLevel":5,"displayLevel":"6","textColor":"#eeeeee","weight":"light","overrideStyle":true} -->
	<div class="section-heading c9-heading text-left"><h5 class="c9-h h6 font-weight-light" style="color:#eeeeee">Highlight the text in the WordPress admin to change quotes, or click on the outer edge C9 Grid block to change the background image or color overlay settings!</h5></div>
	<!-- /wp:c9-blocks/heading -->
	...
	<p class="has-color-light-color has-text-color">Bring to the table win-win <strong>survival strategies</strong> to ensure proactive domination. At the end of the day, going forward, a new normal that has evolved from <a href="#"><mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-color-light-color">generation X</mark></a> is on the runway heading towards a streamlined cloud solution. User generated content in real-time will have multiple touchpoints for offshoring.</p>
	<!-- /wp:paragraph --></div></div>
	<!-- /wp:c9-blocks/column -->
	...
	<div class="c9-grid p-5 p-3 c9-scroll" style="min-height:20vh"><!-- wp:c9-blocks/column-container {"align":"narrow","columns":2,"columnsGap":9,"layout":"c9-2-col-wideleft","containerWidth":"container-narrow","verticalAlign":"center","minScreenHeight":0} -->
	...
	<p class="has-small-font-size">Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits.</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph {"fontSize":"small"} -->
	<p class="has-small-font-size">Bring to the table win-win survival strategies to ensure proactive domination. At the end of the day, going forward, a new normal that has evolved from generation X is on the runway heading towards a streamlined cloud solution. Taking seamless key performance indicators offline to maximise the long tail. Keeping your eye on the ball while performing a deep dive on the start-up mentality to derive convergence on cross-platform integration.</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph {"fontSize":"small"} -->
	<p class="has-small-font-size">Capitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override the digital divide with additional <span style="text-decoration: underline;"><a href="#">clickthroughs</a></span> from DevOps.</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph {"fontSize":"small"} -->
	<p class="has-small-font-size">Podcasting operational change.</p>
	<!-- /wp:paragraph -->
	...
	<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-top"><div class="c9-column-innner"><!-- wp:c9-blocks/image-carousel {"instanceId":1,"autoSlide":false,"url":["https://c9.covertnine.com/wp-content/uploads/2020/10/male-portrait-vertical-683x1024.jpg","https://c9.covertnine.com/wp-content/uploads/2020/10/guitarist-band-vertical-portrait-683x1024.jpg","https://c9.covertnine.com/wp-content/uploads/2020/10/portrait-dark-vert-683x1024.jpg"],"id":[3063,3056,3066],"captionTitle":[null,null,null],"captionContent":[null,null,null],"isResponsive":true,"slideMaxHeight":405,"verticalAlign":"center","className":"container"} -->
	<div id="c9-image-carousel-indicator-1" class="c9-image-carousel container carousel slide container" data-ride="carousel" data-interval="false" data-wrap="true" style="min-height:405px"><ol class="carousel-indicators"><li data-target="#c9-image-carousel-indicator-1" data-slide-to="0" class="active"></li><li data-target="#c9-image-carousel-indicator-1" data-slide-to="1"></li><li data-target="#c9-image-carousel-indicator-1" data-slide-to="2"></li></ol><div class="carousel-inner c9-is-vertically-aligned-center"><div class="carousel-item active"><img src="https://c9.covertnine.com/wp-content/uploads/2020/10/male-portrait-vertical-683x1024.jpg" class="d-block w-100 wp-image-3063"/></div><div class="carousel-item"><img src="https://c9.covertnine.com/wp-content/uploads/2020/10/guitarist-band-vertical-portrait-683x1024.jpg" class="d-block w-100 wp-image-3056"/></div><div class="carousel-item"><img src="https://c9.covertnine.com/wp-content/uploads/2020/10/portrait-dark-vert-683x1024.jpg" class="d-block w-100 wp-image-3066"/></div></div><a class="carousel-control-prev" href="#c9-image-carousel-indicator-1" role="button" data-slide="prev"><span class="carousel-control-prev-icon" aria-hidden="true"></span><span class="sr-only">Previous</span></a><a class="carousel-control-next" href="#c9-image-carousel-indicator-1" role="button" data-slide="next"><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="sr-only">Next</span></a></div>
	...
	<div class="c9-grid p-5 p-3 c9-scroll" style="min-height:64vh;background-color:rgba(244,244,244,1)"><!-- wp:c9-blocks/column-container {"columns":2,"layout":"c9-2-col-equal","verticalAlign":"center","overlayHue":"#ffffff","containerMargin":{"linked":true,"top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"},"containerPadding":{"linked":true,"top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"}} -->
