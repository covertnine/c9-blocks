...
export default {
	...
	<div class="wp-block-group has-covertnine-palette-1-background-color has-background"><div class="wp-block-group__inner-container"><!-- wp:group {"style":{"color":{"background":"#ffffff"}}} -->
