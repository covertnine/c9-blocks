...
export default {
	...
	markup: `<!-- wp:c9-blocks/grid {"instanceId":6,"containerHue":"#313131","overlayHue":"#313131","overlayOpacity":7,"blendMode":"multiply","minScreenHeight":50,"containerVideoURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/restaurant-video-bg-web.mov"} -->
<div class="c9-grid p-5 c9-scroll c9-grid-has-video" style="min-height:50vh;background-color:rgba(49,49,49,1)"><!-- wp:c9-blocks/column-container {"align":"narrow","columns":1,"layout":"one-column","containerWidth":"container-narrow","verticalAlign":"bottom"} -->
...
<!-- wp:c9-blocks/grid {"instanceId":7,"rows":2,"containerImgURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/shawn-ang-nmpW_WwwVSc-unsplash.jpg","containerHue":"#313131","overlayHue":"#313131","overlayOpacity":7,"blendMode":"multiply","minScreenHeight":80,"focalPoint":{"x":0.5345622119815668,"y":1}} -->
<div class="c9-grid p-5 c9-scroll c9-grid-has-background" style="min-height:80vh;background-color:rgba(49,49,49,1)"><!-- wp:c9-blocks/column-container {"columns":2,"layout":"c9-2-col-wideleft","verticalAlign":"center","minScreenHeight":56} -->
...
<!-- wp:c9-blocks/column-container {"align":"wide","columns":3,"columnsGap":4,"layout":"c9-3-col-wideright","verticalAlign":"bottom","overlayHue":"#ffffff","overlayOpacity":10,"containerMargin":{"linked":true,"top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"},"containerPadding":{"linked":true,"top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"}} -->
...
<!-- wp:list -->
<ul><li><strong>Monday </strong>$5 Burgers</li><li><strong>Tuesday</strong> $6 Hot Dogs</li><li><strong>Thursday</strong> $8 Cocktails</li><li><strong>Friday</strong> $4 Shots</li></ul>
<!-- /wp:list -->
...
<!-- wp:c9-blocks/grid {"instanceId":8,"containerHue":"#eeeeee","minScreenHeight":67} -->
...
<div class="wp-block-button aligncenter"><a class="wp-block-button__link no-border-radius" href="#">Get involved</a></div>
<!-- /wp:button -->
...
<!-- wp:c9-blocks/grid {"instanceId":9,"rows":2,"containerImgURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/petr-sevcovic-qE1jxYXiwOA-unsplash.jpg","containerHue":"#313131","overlayHue":"#313131","overlayOpacity":8,"blendMode":"normal","minScreenHeight":80,"focalPoint":{"x":0.4700460829493088,"y":0.8641975308641975}} -->
<div class="c9-grid p-5 c9-scroll c9-grid-has-background" style="min-height:80vh;background-color:rgba(49,49,49,1)"><!-- wp:c9-blocks/column-container {"align":"narrow","columns":1,"layout":"one-column","containerWidth":"container-narrow","verticalAlign":"center","minScreenHeight":43} -->
...
<!-- wp:c9-blocks/column-container {"align":"wide","columns":3,"columnsGap":4,"layout":"c9-3-col-equal","verticalAlign":"bottom","overlayHue":"#ffffff","overlayOpacity":10,"blendMode":"multiply","containerMargin":{"linked":true,"top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"},"containerPadding":{"linked":true,"top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"}} -->
...
<!-- wp:c9-blocks/image-carousel {"instanceId":5,"url":["//cortex.covertnine.com/wp-content/uploads/2019/08/abhishek-sanwa-limbu-LR559Dcst70-unsplash-1024x683.jpg","//cortex.covertnine.com/wp-content/uploads/2019/08/brooke-lark-HlNcigvUi4Q-unsplash-1024x683.jpg","//cortex.covertnine.com/wp-content/uploads/2019/08/brooke-lark-W9OKrxBqiZA-unsplash-1024x683.jpg"],"id":[7340,7342,7341],"isResponsive":true} -->
<div id="c9-image-carousel-indicator-5" class="c9-image-carousel carousel slide" data-ride="carousel" data-interval="5000" data-wrap="true"><ol class="carousel-indicators"><li data-target="#c9-image-carousel-indicator-5" data-slide-to="0" class="active"></li><li data-target="#c9-image-carousel-indicator-5" data-slide-to="1"></li><li data-target="#c9-image-carousel-indicator-5" data-slide-to="2"></li></ol><div class="carousel-inner"><div class="carousel-item active"><img src="//cortex.covertnine.com/wp-content/uploads/2019/08/abhishek-sanwa-limbu-LR559Dcst70-unsplash-1024x683.jpg" class="d-block w-100 wp-image-7340"/></div><div class="carousel-item"><img src="//cortex.covertnine.com/wp-content/uploads/2019/08/brooke-lark-HlNcigvUi4Q-unsplash-1024x683.jpg" class="d-block w-100 wp-image-7342"/></div><div class="carousel-item"><img src="//cortex.covertnine.com/wp-content/uploads/2019/08/brooke-lark-W9OKrxBqiZA-unsplash-1024x683.jpg" class="d-block w-100 wp-image-7341"/></div></div><a class="carousel-control-prev" href="#c9-image-carousel-indicator-5" role="button" data-slide="prev"><span class="carousel-control-prev-icon" aria-hidden="true"></span><span class="sr-only">Previous</span></a><a class="carousel-control-next" href="#c9-image-carousel-indicator-5" role="button" data-slide="next"><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="sr-only">Next</span></a></div>
<!-- /wp:c9-blocks/image-carousel --></div></div>
<!-- /wp:c9-blocks/column -->
...
<!-- wp:c9-blocks/column -->
<div class="c9-block-layout-column c9-column text-left"><div class="c9-column-innner"><!-- wp:c9-blocks/image-carousel {"instanceId":6,"url":["//cortex.covertnine.com/wp-content/uploads/2019/08/rustic-vegan-pRKDJZWNUvY-unsplash-683x1024.jpg","//cortex.covertnine.com/wp-content/uploads/2019/08/jennifer-schmidt-zOlQ7lF-3vs-unsplash-683x1024.jpg","//cortex.covertnine.com/wp-content/uploads/2019/08/edgar-castrejon-1CsaVdwfIew-unsplash-683x1024.jpg"],"id":[7339,7336,7337],"captionTitle":["How do I change the pictures?","Side Salad","Chernobyl Fruit"],"captionContent":["Just click the carousel block to remove the images, change them, or add captions. Even grandma can do it!","This thing is full of weirdness","Good for stronk bones"],"isResponsive":true} -->
<div id="c9-image-carousel-indicator-6" class="c9-image-carousel carousel slide" data-ride="carousel" data-interval="5000" data-wrap="true"><ol class="carousel-indicators"><li data-target="#c9-image-carousel-indicator-6" data-slide-to="0" class="active"></li><li data-target="#c9-image-carousel-indicator-6" data-slide-to="1"></li><li data-target="#c9-image-carousel-indicator-6" data-slide-to="2"></li></ol><div class="carousel-inner"><div class="carousel-item active"><img src="//cortex.covertnine.com/wp-content/uploads/2019/08/rustic-vegan-pRKDJZWNUvY-unsplash-683x1024.jpg" class="d-block w-100 wp-image-7339"/><div class="carousel-caption d-none d-md-block"><h5>How do I change the pictures?</h5><p>Just click the carousel block to remove the images, change them, or add captions. Even grandma can do it!</p></div></div><div class="carousel-item"><img src="//cortex.covertnine.com/wp-content/uploads/2019/08/jennifer-schmidt-zOlQ7lF-3vs-unsplash-683x1024.jpg" class="d-block w-100 wp-image-7336"/><div class="carousel-caption d-none d-md-block"><h5>Side Salad</h5><p>This thing is full of weirdness</p></div></div><div class="carousel-item"><img src="//cortex.covertnine.com/wp-content/uploads/2019/08/edgar-castrejon-1CsaVdwfIew-unsplash-683x1024.jpg" class="d-block w-100 wp-image-7337"/><div class="carousel-caption d-none d-md-block"><h5>Chernobyl Fruit</h5><p>Good for stronk bones</p></div></div></div><a class="carousel-control-prev" href="#c9-image-carousel-indicator-6" role="button" data-slide="prev"><span class="carousel-control-prev-icon" aria-hidden="true"></span><span class="sr-only">Previous</span></a><a class="carousel-control-next" href="#c9-image-carousel-indicator-6" role="button" data-slide="next"><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="sr-only">Next</span></a></div>
<!-- /wp:c9-blocks/image-carousel -->
