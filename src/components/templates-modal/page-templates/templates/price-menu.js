...
<div class="c9-horizontal-tabs-tab tab-pane fade show active" role="tabpanel" id="htab-tab-weekday-0" aria-labelledby="tab-weekday"><!-- wp:list -->
...
<div class="c9-horizontal-tabs-tab tab-pane fade" role="tabpanel" id="htab-tab-weekend-0" aria-labelledby="tab-weekend"><!-- wp:paragraph {"align":"center"} -->
