...
export default {
	...
	<div class="c9-grid p-5 c9-fixed c9-grid-has-background" style="min-height:70vh;background-color:rgba(7,7,7,1)"><!-- wp:c9-blocks/column-container {"align":"full","columns":1,"columnMaxWidth":600,"layout":"c9-1-col-equal","containerWidth":"container-fluid","verticalAlign":"center"} -->
	...
	<!-- wp:c9-blocks/heading {"heading":"Offer Headline","displayLevel":"4","type":"c9-txl display-","textColor":"#ffffff","textAlign":"center","overrideStyle":true} -->
	...
	<!-- wp:group {"style":{"color":{"background":"#1e1e1e"}}} -->
	...
	<p class="has-text-align-center has-covertnine-palette-1-color has-text-color has-medium-font-size"><strong>Enter your email now!</strong></p>
	<!-- /wp:paragraph -->

	<!-- wp:paragraph {"align":"center","textColor":"covertnine-palette-1","fontSize":"larger"} -->
	<p class="has-text-align-center has-covertnine-palette-1-color has-text-color has-larger-font-size">[insert form]</p>
	<!-- /wp:paragraph -->

	<!-- wp:button {"style":{"color":{"background":"#cb282b"}},"align":"center"} -->
	...
	<div class="section-heading c9-heading text-left"><h3 class="c9-h h3">Offer</h3><div class="c9-h h3"><small class="text-muted">&nbsp;Details</small></div></div>
	<!-- /wp:c9-blocks/heading -->
	...
	<div class="c9-block-layout-column c9-column text-left"><div class="c9-column-innner"><!-- wp:c9-blocks/heading {"heading":"Know someone who would love this thing? Tell em!","tagLevel":2,"displayLevel":"5","type":"c9-txl display-","textAlign":"center","weight":"bold","overrideStyle":true} -->
	<div class="section-heading c9-heading text-center"><h2 class="c9-txl display-5 font-weight-bold">Know someone who would love this thing? Tell em!</h2></div>
	<!-- /wp:c9-blocks/heading -->
