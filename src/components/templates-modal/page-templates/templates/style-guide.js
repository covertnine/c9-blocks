...
export default {
	...
	<div class="wp-block-buttons"><!-- wp:button {"textColor":"color-warning","className":"is-style-outline"} -->
	<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-color-warning-color has-text-color wp-element-button" href="#">Outlined</a></div>
	<!-- /wp:button -->
	...
	<p class=""><strong>Quote Block. </strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
	...
	<!-- wp:heading {"level":3} -->
	<h3 class="">C9 Image Carousel Block</h3>
	<!-- /wp:heading -->
	...
	<!-- wp:paragraph -->
	<p class="">Proin accumsan sagittis tortor vitae scelerisque. Aliquam sagittis elit eget nisl blandit, in hendrerit turpis condimentum. Ut id euismod odio. Nunc laoreet mi at nulla venenatis efficitur. Nunc scelerisque odio ut ipsum convallis fermentum. Mauris eu quam eget nibh finibus rhoncus vitae nec lorem. Suspendisse congue orci mi, vitae fringilla urna aliquet malesuada. Morbi eu metus viverra, sodales ligula sit amet, consectetur purus. Suspendisse posuere metus eget lectus consectetur dapibus euismod ut lectus. Phasellus id efficitur quam.</p>
	<!-- /wp:paragraph -->
	...
	<div class="c9-posts-grid p-3 c9-scroll" style="min-height:20vh"><!-- wp:c9-blocks/post-grid {"displayPostDate":true,"displayPostExcerpt":true,"displayPostAuthor":true,"displayPostLink":true,"displaySectionTitle":true,"postTitleTag":"h4","columns":3,"sectionTitle":"C9 Posts Grid Block","imageSize":"c9-feature-medium-crop"} /--></div>
