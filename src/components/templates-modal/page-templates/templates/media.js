...
export default {
	...
	markup: `<!-- wp:c9-blocks/grid {"instanceId":0,"containerHue":"#313131","overlayHue":"#313131","overlayOpacity":6,"blendMode":"multiply","minScreenHeight":80,"videoType":"embed","containerVideoID":"vbv_aZuXMIw"} -->
	<div class="c9-grid p-5 c9-scroll c9-grid-has-video" style="min-height:80vh;background-color:rgba(49,49,49,1)"><div class="c9-video-container"><div class="c9-embed-container"><div id="player-vbv_aZuXMIw-0" class="c9-video" video-id="vbv_aZuXMIw" style="min-height:80vh"></div></div></div><div class="c9-overlay-container" style="background-color:rgba(49,49,49,.6);mix-blend-mode:multiply"></div><!-- wp:c9-blocks/column-container {"columns":1,"layout":"one-column","verticalAlign":"bottom","containerPadding":{"linked":true,"top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"}} -->
	...
	<!-- wp:c9-blocks/grid {"instanceId":1,"containerImgURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/audience-backlit-band-154147-web.jpg","overlayHue":"#00d084","blendMode":"normal","minScreenHeight":70} -->
	...
	<!-- wp:c9-blocks/grid {"instanceId":4,"minScreenHeight":10,"containerMargin":{"linked":true,"unit":"px","top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"},"containerPadding":{"linked":true,"top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"}} -->
