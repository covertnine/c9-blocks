export default {
	...
	<!-- wp:paragraph -->
	<p class="">Annual billing for discount</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph -->
	<p class="">On-demand work</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph -->
	<p class="">When you need it</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph -->
	<p class="">Flexible timelines</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph -->
	<p class="">Reliable + high quality</p>
	<!-- /wp:paragraph -->
	...
	<!-- wp:paragraph -->
	<p class="">Weekly meeting reviews</p>
	<!-- /wp:paragraph --></div></div>
	<!-- /wp:c9-blocks/column -->
	
	<!-- wp:c9-blocks/column -->
	<div class="c9-block-layout-column c9-column text-left"><div class="c9-column-innner"><!-- wp:paragraph -->
	<p class="">Discover/Design/Develop/Launch</p>
	<!-- /wp:paragraph -->
	...
	<!-- wp:paragraph -->
	<p class="">Reliable Timelines</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph -->
	<p class="">W3C Standard Work</p>
	<!-- /wp:paragraph -->
	
	<!-- wp:paragraph -->
	<p class="">Award Winning Support</p>
	<!-- /wp:paragraph --></div></div>
	<!-- /wp:c9-blocks/column --></div></div>
	<!-- /wp:c9-blocks/column-container -->
	<!-- /wp:c9-blocks/horizontal-tabs-tab -->
	
	<!-- wp:c9-blocks/horizontal-tabs-tab {"slug":"tab-subscriptions","tabActive":"tab-subscriptions","id":0} -->
	...
	<div class="c9-block-layout-column c9-column text-left mr-5"><div class="c9-column-innner"><!-- wp:spacer {"height":"20px"} -->
	<div style="height:20px" aria-hidden="true" class="wp-block-spacer"></div>
	<!-- /wp:spacer -->
	...
	<!-- wp:c9-blocks/horizontal-tabs-tab {"slug":"tab-hourly","tabActive":"tab-subscriptions","id":0} -->
	...
	<!-- wp:button -->
	<div class="wp-block-button"><a class="wp-block-button__link wp-element-button">Purchase</a></div>
	<!-- /wp:button --></div></div>
	<!-- /wp:c9-blocks/column -->
	...
	<div class="c9-grid p-5 p-3 c9-scroll c9-grid-has-background" style="min-height:100vh;background-color:rgba(7,7,7,1)"><!-- wp:c9-blocks/column-container {"align":"full","columns":1,"columnMaxWidth":600,"layout":"c9-1-col-equal","containerWidth":"container-fluid","verticalAlign":"center","minScreenHeight":0,"containerMargin":{"linked":false,"top":"5","bottom":"5","left":"5","right":"5","icon":"editor-unlink"}} -->
