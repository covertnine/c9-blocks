...
export default {
	...
	markup: `<!-- wp:c9-blocks/grid {"instanceId":4,"rows":2,"containerImgURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/audience-celebration-concert-1179581-web66.jpg","containerHue":"#313131","bgImgAttach":true,"overlayHue":"#313131","overlayOpacity":9,"blendMode":"multiply","minScreenHeight":90,"focalPoint":{"x":0.06451612903225806,"y":0}} -->
<div class="c9-grid p-5 c9-fixed c9-grid-has-background" style="min-height:90vh;background-color:rgba(49,49,49,1)"><!-- wp:c9-blocks/column-container {"columns":1,"layout":"one-column"} -->
...
<!-- wp:c9-blocks/grid {"instanceId":6,"containerImgURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/ali-yahya-ytNFYf4d_30-unsplash-web-1.jpg","containerHue":"#313131","overlayHue":"#313131","overlayOpacity":8,"blendMode":"multiply","minScreenHeight":60,"containerVideoURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/Pexels-Videos-2706-1.mp4","focalPointMobile":{"x":0.25,"y":0.5},"overrideMobile":true} -->
<div class="c9-grid p-5 c9-scroll c9-grid-has-background c9-grid-has-video" style="min-height:60vh;background-color:rgba(49,49,49,1)"><!-- wp:c9-blocks/column-container {"columns":2,"layout":"c9-2-col-wideleft","verticalAlign":"center"} -->
...
<!-- wp:button {"customBackgroundColor":"#2bb249","className":"is-style-default"} -->
...
<div class="c9-toggles-toggle"><div class="c9-toggles-item-heading" id="c9-toggles-heading4-0" data-toggle="collapse" data-target="#c9-toggles-collapse4-0"><div class="mb-0"><span class="c9-toggles-toggle-label"><strong>4. </strong>What does an image carousel look like?</span><span class="c9-toggles-item-collapse"><span class="fas fa-angle-right"></span></span></div></div><div class="c9-toggles-item-content collapse" id="c9-toggles-collapse4-0" data-parent="#accordion-0"><div><!-- wp:c9-blocks/image-carousel {"instanceId":6,"url":["//cortex.covertnine.com/wp-content/uploads/2019/08/crowd-dancing-1024x682.jpg","//cortex.covertnine.com/wp-content/uploads/2019/08/adult-applause-audience-625644-web-1024x682.jpg","//cortex.covertnine.com/wp-content/uploads/2019/08/audience-backlit-band-154147-web-1024x682.jpg"],"id":[7547,7535,7534]} -->
...
<!-- wp:c9-blocks/carousel {"instanceId":0,"slides":3,"autoSlide":false} -->
...
<!-- wp:c9-blocks/grid {"instanceId":10,"containerHue":"#e9e9e9"} -->
...
<!-- wp:paragraph -->
<p>Nanotechnology immersion along the information highway will close the loop.&nbsp;<a href="http://cortex.covertnine.com/service-landing-page/#">Learn how to do the thing</a></p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:c9-blocks/column --></div></div>
<!-- /wp:c9-blocks/column-container --></div>
<!-- /wp:c9-blocks/grid -->

<!-- wp:c9-blocks/grid {"instanceId":11,"containerHue":"#363636","minScreenHeight":10,"containerPadding":{"linked":true,"top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"}} -->
<div class="c9-grid c9-scroll" style="min-height:10vh;background-color:rgba(54,54,54,1)"><!-- wp:c9-blocks/column-container {"align":"narrow","columns":1,"layout":"one-column","containerWidth":"container-narrow","verticalAlign":"center"} -->
...
<!-- wp:c9-blocks/grid {"instanceId":12,"containerMargin":{"linked":true,"unit":"px","top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"}} -->
...
<!-- wp:c9-blocks/grid {"instanceId":13,"containerImgURL":"https://cortex.covertnine.com/wp-content/uploads/2020/01/man-with-headphones-facing-computer-monitor-845451.jpg","overlayHue":"#abb8c3","overlayOpacity":4,"blendMode":"multiply","minScreenHeight":75,"containerMargin":{"linked":true,"unit":"px","top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"},"focalPoint":{"x":0.4976958525345622,"y":0.22916666666666666},"focalPointMobile":{"x":0.75,"y":0.25},"overrideMobile":true} -->
<div class="c9-grid p-5 c9-scroll c9-grid-has-background" style="min-height:75vh"><!-- wp:c9-blocks/column-container {"columns":2,"layout":"c9-2-col-wideleft"} -->
<div class="container c9-column-container c9-scroll c9-layout-columns-2 c9-2-col-wideleft"><div class="c9-layout-column-wrap c9-block-layout-column-gap-2 c9-is-responsive-column"><!-- wp:c9-blocks/column -->
...
<!-- /wp:button --></div></div>
<!-- /wp:c9-blocks/column --></div></div>
<!-- /wp:c9-blocks/column-container --><div class="c9-overlay-container" style="background-color:rgba(171,184,195,.4);mix-blend-mode:multiply"></div><div class="c9-image-container c9-image-mobile-top-right c9-image-mobile-size-cover" style="background-position:49.76958525345622% 22.916666666666664%;background-image:url(https://cortex.covertnine.com/wp-content/uploads/2020/01/man-with-headphones-facing-computer-monitor-845451.jpg);background-repeat:no-repeat;background-size:cover"></div></div>
<!-- /wp:c9-blocks/grid -->

<!-- wp:c9-blocks/grid {"instanceId":14,"containerHue":"#eeeeee","minScreenHeight":50,"containerMargin":{"linked":true,"unit":"px","top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"}} -->
...
<!-- wp:paragraph -->
<p><a href="http://cortex.covertnine.com/service-landing-page/#">Learn more</a></p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:c9-blocks/column -->
...
<!-- wp:c9-blocks/grid {"instanceId":17} -->
...
<!-- wp:c9-blocks/grid {"instanceId":18,"containerImgURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/crowd-dancing.jpg","containerHue":"#313131","overlayHue":"#313131","overlayOpacity":10,"blendMode":"multiply","minScreenHeight":70,"focalPoint":{"x":0.2350230414746544,"y":0.4375},"focalPointMobile":{"x":0.25,"y":0.5},"overrideMobile":true} -->
<div class="c9-grid p-5 c9-scroll c9-grid-has-background" style="min-height:70vh;background-color:rgba(49,49,49,1)"><!-- wp:c9-blocks/column-container {"columns":2,"columnMaxWidth":600,"layout":"c9-2-col-wideleft","verticalAlign":"center"} -->
...
<!-- wp:button {"textColor":"covertnine-palette-1","customBackgroundColor":"#cd282b","className":"is-style-default"} -->
<div class="wp-block-button is-style-default"><a class="wp-block-button__link has-text-color has-covertnine-palette-1-color has-background" href="#" style="background-color:#cd282b">Get Started</a></div>
<!-- /wp:button --></div></div>
<!-- /wp:c9-blocks/column -->
