...
<!-- wp:button {"textColor":"covertnine-palette-1","customBackgroundColor":"#6000fa","align":"center","className":"is-style-default"} -->
<div class="wp-block-button aligncenter is-style-default"><a class="wp-block-button__link has-text-color has-covertnine-palette-1-color has-background" href="#" style="background-color:#6000fa">get tickets</a></div>
<!-- /wp:button --></div></div>
<!-- /wp:c9-blocks/column -->
...
<!-- wp:button {"customBackgroundColor":"#27b066","borderRadius":0,"align":"center"} -->
...
<!-- wp:button {"customBackgroundColor":"#c9282a","borderRadius":0,"align":"center"} -->
