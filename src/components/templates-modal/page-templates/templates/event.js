export default {
	...
	<!-- wp:c9-blocks/carousel {"instanceId":1,"autoSlide":false,"slideMaxHeight":-1} -->
	<div id="c9-carousel-indicator-1" class="c9-carousel carousel slide container" data-ride="carousel" data-interval="false" data-wrap="true" style="min-height:-1px"><ol class="carousel-indicators"><li data-target="#c9-carousel-indicator-1" data-slide-to="0" class="active"></li><li data-target="#c9-carousel-indicator-1" data-slide-to="1"></li><li data-target="#c9-carousel-indicator-1" data-slide-to="2"></li></ol><div class="carousel-inner"><!-- wp:c9-blocks/carousel-slide {"id":0,"slideActive":0,"slides":3} -->
	<div class="c9-carousel-slide carousel-item active"><!-- wp:gallery {"columns":4,"linkTo":"none","sizeSlug":"full"} -->
	<figure class="wp-block-gallery has-nested-images columns-4 is-cropped"><!-- wp:image {"id":3086,"sizeSlug":"full","linkDestination":"none"} -->
	<figure class="wp-block-image size-full"><img src="https://c9.covertnine.com/wp-content/uploads/2020/10/c9-starter-img-1.png" alt="" class="wp-image-3086"/></figure>
	<!-- /wp:image -->
	
	<!-- wp:image {"id":3087,"sizeSlug":"full","linkDestination":"none"} -->
	<figure class="wp-block-image size-full"><img src="https://c9.covertnine.com/wp-content/uploads/2020/10/c9-starter-img-2.png" alt="" class="wp-image-3087"/></figure>
	<!-- /wp:image -->
	
	<!-- wp:image {"id":3088,"sizeSlug":"full","linkDestination":"none"} -->
	<figure class="wp-block-image size-full"><img src="https://c9.covertnine.com/wp-content/uploads/2020/10/c9-starter-img-3.png" alt="" class="wp-image-3088"/></figure>
	<!-- /wp:image -->
	
	<!-- wp:image {"id":3090,"sizeSlug":"full","linkDestination":"none"} -->
	<figure class="wp-block-image size-full"><img src="https://c9.covertnine.com/wp-content/uploads/2020/10/c9-starter-img-4.png" alt="" class="wp-image-3090"/></figure>
	<!-- /wp:image --></figure>
	<!-- /wp:gallery --></div>
	...
	<!-- wp:c9-blocks/cta {"type":"c9-h","buttonText":"Get Tickets","buttonSize":"c9-button-size-extralarge","ctaBackgroundColor":"#e7e7e7","disableToolbar":true} -->
	<div style="background-color:rgba(231,231,231,1);text-align:left" class="c9-cta c9-block-cta container p-5"><div class="row"><div class="c9-cta-content col-12 col-md-8"><div class="c9-cta-text c9-h" style="font-size:1.6rem"><p>Get your tickets for the lowest price available now by clicking on the button!</p></div></div><div class="c9-cta-button col-12 col-md-4"><a href="#" target="_self" rel="noopener noreferrer" class="wp-block-button__link c9-button-shape-square c9-button-size-extralarge" style="color:#ffffff">Get Tickets</a></div></div></div>
	<!-- /wp:c9-blocks/cta -->
	...
	<div class="c9-grid p-5 p-3 my-5 c9-fixed c9-grid-has-background" style="min-height:75vh"><!-- wp:c9-blocks/column-container {"columns":2,"layout":"c9-2-col-wideleft","minScreenHeight":0} -->
	...
	<div class="c9-grid p-5 p-3 my-5 c9-fixed c9-grid-has-background" style="min-height:85vh"><!-- wp:c9-blocks/column-container {"columns":2,"layout":"c9-2-col-wideleft","verticalAlign":"bottom","overlayHue":"#ffffff","overlayOpacity":10,"minScreenHeight":5,"containerMargin":{"linked":false,"top":"-1","bottom":"5","left":"5","right":"5","icon":"editor-unlink"},"containerPadding":{"linked":true,"top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"}} -->
	...
	<div class="c9-grid p-5 p-3 my-5 c9-fixed c9-grid-has-background" style="min-height:75vh"><!-- wp:c9-blocks/column-container {"columns":2,"layout":"c9-2-col-wideleft","verticalAlign":"bottom","minScreenHeight":0} -->
	...
	<div class="c9-grid p-5 p-3 c9-scroll c9-grid-has-background" style="min-height:78vh"><!-- wp:c9-blocks/column-container {"align":"wide","columns":2,"columnsGap":10,"layout":"c9-2-col-wideright","verticalAlign":"center","minScreenHeight":80,"containerMargin":{"linked":true,"top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"},"containerPadding":{"linked":true,"top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"}} -->
	...
	<div class="container c9-column-container p-5 my-5 c9-scroll c9-layout-columns-2 c9-2-col-equal" style="min-height:10vh"><div class="c9-layout-column-wrap c9-block-layout-column-gap-10 c9-is-responsive-column"><!-- wp:c9-blocks/column -->
	...
	<!-- wp:c9-blocks/grid {"instanceId":6,"containerHue":"#f4f4f4","minScreenHeight":64,"className":"p-5"} -->
	...
	<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-center"><div class="c9-column-innner"><!-- wp:image {"id":3142,"sizeSlug":"large","linkDestination":"none"} -->
	<figure class="wp-block-image size-large"><img src="https://c9.covertnine.com/wp-content/uploads/2020/10/c9-event-placeholder-flyer-683x1024.jpg" alt="Flyer caption" class="wp-image-3142"/><figcaption class="wp-element-caption">Flyer Caption</figcaption></figure>
	<!-- /wp:image --></div></div>
	<!-- /wp:c9-blocks/column -->
	...
	<p class="">Leverage agile frameworks to provide a robust synopsis for high level overviews. </p>
