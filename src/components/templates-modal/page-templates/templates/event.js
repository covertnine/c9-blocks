...
export default {
	...
	markup: `<!-- wp:c9-blocks/grid {"instanceId":0,"containerImgURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/adult-applause-audience-625644-web.jpg","containerHue":"#313131","overlayHue":"#313131","overlayOpacity":7,"blendMode":"multiply","minScreenHeight":60,"containerMargin":{"linked":true,"unit":"px","top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"},"focalPoint":{"x":0.5529953917050692,"y":0.4722222222222222},"containerVideoURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/concert-video.mp4.mp4"} -->
	<div class="c9-grid p-5 c9-scroll c9-grid-has-background c9-grid-has-video" style="min-height:60vh;background-color:rgba(49,49,49,1)"><!-- wp:c9-blocks/column-container {"columns":2,"columnsGap":10,"layout":"c9-2-col-wideleft","verticalAlign":"center"} -->
	...
	<!-- wp:c9-blocks/heading {"heading":"September 13-15 | Welles Park","tagLevel":2,"type":"c9-sh subhead-h","textColor":"#d6d6d6","textAlign":"center","weight":"light"} -->
	<div class="section-heading c9-heading text-center"><h2 class="c9-sh font-weight-light" style="color:#d6d6d6">September 13-15 | Welles Park</h2></div>
	<!-- /wp:c9-blocks/heading -->

	<!-- wp:c9-blocks/heading {"heading":"Click on the section's outer edge of the C9 Grid block to select it and changes its background overlay, imagery, or video. If you don't see a sidebar when clicking on the C9 Grid block, click the gear icon and then change Background Settings. Click the \u003cstrong\u003eSELECT COLUMN CONTAINER\u003c/strong\u003e button to make changes to the responsive grid containers and column numbers","tagLevel":6,"displayLevel":"6","type":"c9-sh subhead-h","textColor":"#7f7f7f","textAlign":"center","weight":"light","overrideStyle":true} -->
	<div class="section-heading c9-heading text-center"><h6 class="c9-sh subhead-h6 font-weight-light" style="color:#7f7f7f">Click on the section's outer edge of the C9 Grid block to select it and changes its background overlay, imagery, or video. If you don't see a sidebar when clicking on the C9 Grid block, click the gear icon and then change Background Settings. Click the <strong>SELECT COLUMN CONTAINER</strong> button to make changes to the responsive grid containers and column numbers</h6></div>
	<!-- /wp:c9-blocks/heading -->
	...
	<!-- wp:button {"style":{"color":{"background":"#6000fa"}},"textColor":"covertnine-palette-1","align":"center","className":"is-style-default"} -->
	<div class="wp-block-button aligncenter is-style-default"><a class="wp-block-button__link has-covertnine-palette-1-color has-text-color has-background" href="#" style="background-color:#6000fa">get tickets</a></div>
	<!-- /wp:button --></div></div>
	<!-- /wp:c9-blocks/column -->

	<!-- wp:c9-blocks/column {"verticalAlign":"center"} -->
	<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-center"><div class="c9-column-innner"><!-- wp:image {"align":"center","width":125,"height":106} -->
	<div class="wp-block-image"><figure class="aligncenter is-resized"><img src="//cortex.covertnine.com/wp-content/uploads/2019/08/C9-RECORDS-placeholder.png" alt="" width="125" height="106"/></figure></div>
	<!-- /wp:image --></div></div>
	...
	<!-- wp:paragraph -->
	<p><strong>Click on the section’s outer edge of the C9 Grid block to select it and changes its background overlay, imagery, or video. If you don’t see a sidebar when clicking on the C9 Grid block, click the gear icon and then change Background Settings</strong></p>
	<!-- /wp:paragraph -->
	...
	<!-- wp:c9-blocks/grid {"instanceId":2,"containerImgURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/candice-picard-mqSLs9mKIOc-unsplash.jpg","overlayOpacity":4,"blendMode":"multiply","minScreenHeight":75,"containerMargin":{"linked":true,"unit":"px","top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"},"focalPoint":{"x":0.5299539170506913,"y":0.4236111111111111}} -->
	<div class="c9-grid p-5 my-5 c9-scroll c9-grid-has-background" style="min-height:75vh"><!-- wp:c9-blocks/column-container {"columns":2,"layout":"c9-2-col-wideleft"} -->
	...
	<!-- wp:c9-blocks/column -->
	<div class="c9-block-layout-column c9-column text-left"><div class="c9-column-innner"><!-- wp:c9-blocks/heading {"heading":"$19 / ADVANCED","tagLevel":5,"textAlign":"center","overrideStyle":true} -->
	<div class="section-heading c9-heading text-center"><h5 class="c9-h h5">$19 / ADVANCED</h5></div>
	<!-- /wp:c9-blocks/heading -->
	...
	<div class="wp-block-button aligncenter"><a class="wp-block-button__link no-border-radius">Get Tickets</a></div>
	<!-- /wp:button --></div></div>
	<!-- /wp:c9-blocks/column --></div></div>
	...
	<!-- wp:c9-blocks/grid {"instanceId":3,"containerImgURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/gutenberg-event-page-template-band.jpg","overlayHue":"#900808","minScreenHeight":85,"containerMargin":{"linked":true,"unit":"px","top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"},"focalPoint":{"x":0.4838709677419355,"y":0.6388888888888888},"focalPointMobile":{"x":0.5,"y":0.75},"overrideMobile":true} -->
	<div class="c9-grid p-5 my-5 c9-scroll c9-grid-has-background" style="min-height:85vh"><!-- wp:c9-blocks/column-container {"columns":2,"layout":"c9-2-col-wideleft","verticalAlign":"bottom","overlayHue":"#ffffff","overlayOpacity":10,"minScreenHeight":5,"containerMargin":{"linked":false,"top":"-1","bottom":"5","left":"5","right":"5","icon":"editor-unlink"},"containerPadding":{"linked":true,"top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"}} -->
	...
	<!-- wp:paragraph -->
	<p>Click on the section's outer edge of the C9 Grid block to select it and changes its background overlay, imagery, or video. If you don't see a sidebar when clicking on the C9 Grid block, click the gear icon and then change Background Settings. Click the <strong>SELECT COLUMN CONTAINER</strong> button to make changes to the responsive grid containers and column numbers</p>
	...
	<!-- wp:button {"borderRadius":0,"style":{"color":{"background":"#27b066"}},"align":"center"} -->
	<div class="wp-block-button aligncenter"><a class="wp-block-button__link has-background no-border-radius" href="#" style="background-color:#27b066">Get Tickets</a></div>
	<!-- /wp:button --></div></div>
	<!-- /wp:c9-blocks/column --></div></div>
	<!-- /wp:c9-blocks/column-container --><div class="c9-overlay-container" style="background-color:rgba(144,8,8,.5);mix-blend-mode:overlay"></div><div class="c9-image-container c9-image-mobile-bottom-center c9-image-mobile-size-cover" style="background-position:48.38709677419355% 63.888888888888886%;background-image:url(//cortex.covertnine.com/wp-content/uploads/2019/08/gutenberg-event-page-template-band.jpg);background-repeat:no-repeat;background-size:cover"></div></div>
	<!-- /wp:c9-blocks/grid -->
	...
	<!-- wp:c9-blocks/grid {"instanceId":4,"containerImgURL":"https://cortex.covertnine.com/wp-content/uploads/2020/01/tony-pham-7YfMrHWBm0U-unsplash.jpg","overlayHue":"#2f2f2f","blendMode":"normal","minScreenHeight":75,"containerMargin":{"linked":true,"unit":"px","top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"},"focalPoint":{"x":0.5299539170506913,"y":0.4236111111111111},"focalPointMobile":{"x":0.5,"y":0.75},"overrideMobile":true} -->
	<div class="c9-grid p-5 my-5 c9-scroll c9-grid-has-background" style="min-height:75vh"><!-- wp:c9-blocks/column-container {"columns":2,"layout":"c9-2-col-wideleft","verticalAlign":"bottom"} -->
	...
	<!-- /wp:button --></div></div>
	<!-- /wp:c9-blocks/column --></div></div>
	<!-- /wp:c9-blocks/column-container --><div class="c9-overlay-container" style="background-color:rgba(47,47,47,.5);mix-blend-mode:normal"></div><div class="c9-image-container c9-image-mobile-bottom-center c9-image-mobile-size-cover" style="background-position:52.995391705069125% 42.36111111111111%;background-image:url(https://cortex.covertnine.com/wp-content/uploads/2020/01/tony-pham-7YfMrHWBm0U-unsplash.jpg);background-repeat:no-repeat;background-size:cover"></div></div>
	<!-- /wp:c9-blocks/grid -->

	<!-- wp:c9-blocks/grid {"instanceId":5,"containerImgURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/music-bg.jpg","overlayHue":"#7a0002","overlayOpacity":10,"blendMode":"multiply","minScreenHeight":78} -->
	<div class="c9-grid p-5 c9-scroll c9-grid-has-background" style="min-height:78vh"><!-- wp:c9-blocks/column-container {"align":"narrow","columns":2,"columnsGap":10,"layout":"c9-2-col-equal","containerWidth":"container-narrow","verticalAlign":"center"} -->
	<div class="container-narrow c9-column-container c9-scroll c9-layout-columns-2 c9-is-vertically-aligned-center c9-2-col-equal"><div class="c9-layout-column-wrap c9-block-layout-column-gap-10 c9-is-responsive-column"><!-- wp:c9-blocks/column {"verticalAlign":"center"} -->
	...
	<!-- wp:c9-blocks/column {"verticalAlign":"center"} -->
	<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-center"><div class="c9-column-innner"><!-- wp:c9-blocks/image-carousel {"instanceId":0,"url":["https://cortex.covertnine.com/wp-content/uploads/2020/01/black-and-white-crew-neck-shirt-1808711-1024x683.jpg","//cortex.covertnine.com/wp-content/uploads/2019/08/candice-picard-mqSLs9mKIOc-unsplash-1024x683.jpg","//cortex.covertnine.com/wp-content/uploads/2019/08/amos-bar-zeev-hVk6pIFbW9o-unsplash-1024x683.jpg"],"id":[2214,7662,7819],"captionTitle":["Slide Caption","Slide Label","Slide Label"],"captionContent":[null,"Slide Sub Label","Slide Subheading Label"]} -->
	<div id="c9-image-carousel-indicator-0" class="c9-image-carousel carousel slide" data-ride="carousel" data-interval="5000" data-wrap="true"><ol class="carousel-indicators"><li data-target="#c9-image-carousel-indicator-0" data-slide-to="0" class="active"></li><li data-target="#c9-image-carousel-indicator-0" data-slide-to="1"></li><li data-target="#c9-image-carousel-indicator-0" data-slide-to="2"></li></ol><div class="carousel-inner"><div class="carousel-item active"><img src="https://cortex.covertnine.com/wp-content/uploads/2020/01/black-and-white-crew-neck-shirt-1808711-1024x683.jpg" class="d-block w-100"/><div class="carousel-caption d-none d-md-block"><h5>Slide Caption</h5></div></div><div class="carousel-item"><img src="//cortex.covertnine.com/wp-content/uploads/2019/08/candice-picard-mqSLs9mKIOc-unsplash-1024x683.jpg" class="d-block w-100"/><div class="carousel-caption d-none d-md-block"><h5>Slide Label</h5><p>Slide Sub Label</p></div></div><div class="carousel-item"><img src="//cortex.covertnine.com/wp-content/uploads/2019/08/amos-bar-zeev-hVk6pIFbW9o-unsplash-1024x683.jpg" class="d-block w-100"/><div class="carousel-caption d-none d-md-block"><h5>Slide Label</h5><p>Slide Subheading Label</p></div></div></div><a class="carousel-control-prev" href="#c9-image-carousel-indicator-0" role="button" data-slide="prev"><span class="carousel-control-prev-icon" aria-hidden="true"></span><span class="sr-only">Previous</span></a><a class="carousel-control-next" href="#c9-image-carousel-indicator-0" role="button" data-slide="next"><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="sr-only">Next</span></a></div>
	<!-- /wp:c9-blocks/image-carousel --></div></div>
	<!-- /wp:c9-blocks/column --></div></div>
	<!-- /wp:c9-blocks/column-container --><div class="c9-overlay-container" style="background-color:rgba(122,0,2,1);mix-blend-mode:multiply"></div><div class="c9-image-container c9-image-mobile-size-cover" style="background-position:50% 50%;background-image:url(//cortex.covertnine.com/wp-content/uploads/2019/08/music-bg.jpg);background-repeat:no-repeat;background-size:cover"></div></div>
	<!-- /wp:c9-blocks/grid -->
	...
	<!-- wp:c9-blocks/column {"verticalAlign":"center"} -->
	<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-center"><div class="c9-column-innner"><!-- wp:c9-blocks/heading {"heading":"Venue Limitations","tagLevel":5,"overrideStyle":true} -->
	<div class="section-heading c9-heading text-left"><h5 class="c9-h h5">Venue Limitations</h5></div>
	<!-- /wp:c9-blocks/heading -->
