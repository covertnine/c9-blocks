...
export default {
	...
	markup: `<!-- wp:c9-blocks/grid {"instanceId":0,"containerHue":"#000000","overlayHue":"#3d3d3d","overlayOpacity":9,"blendMode":"multiply","minScreenHeight":50,"containerVideoURL":"http://cortex.covertnine.com/wp-content/uploads/2019/10/Pexels-Videos-1333384.mp4"} -->
<div class="c9-grid p-5 c9-scroll c9-grid-has-video" style="min-height:50vh;background-color:rgba(0,0,0,1)"><div class="c9-video-container"><div class="c9-embed-container"><video id="containerVideo-0" class="c9-video-custom" playsinline autoplay muted loop style="min-height:50vh"><source src="http://cortex.covertnine.com/wp-content/uploads/2019/10/Pexels-Videos-1333384.mp4" type="video/mp4"/></video></div></div><div class="c9-overlay-container" style="background-color:rgba(61,61,61,.9);mix-blend-mode:multiply"></div><!-- wp:c9-blocks/column-container {"columns":2,"layout":"c9-2-col-wideright","verticalAlign":"center"} -->
...
<!-- wp:paragraph {"align":"center","textColor":"covertnine-palette-1"} -->
<p class="has-text-color has-text-align-center has-covertnine-palette-1-color">Vestibulum aliquam felis imperdiet, ornare turpis ut, feugiat est. Curabitur eget molestie diam. Aliquam erat volutpat. Maecenas efficitur dignissim lorem, ac ultrices.</p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:c9-blocks/column --></div></div>
<!-- /wp:c9-blocks/column-container --></div>
<!-- /wp:c9-blocks/grid -->

<!-- wp:c9-blocks/grid {"instanceId":1,"containerPadding":{"linked":true,"top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"}} -->
...
<div class="section-heading c9-heading text-center"><h3 class="c9-txl display-1 font-weight-light">Teaser Video</h3></div>
<!-- /wp:c9-blocks/heading -->
...
<div class="wp-block-button aligncenter"><a class="wp-block-button__link" href="#">See more on youtube</a></div>
<!-- /wp:button --></div></div>
<!-- /wp:c9-blocks/column -->
...
<!-- wp:c9-blocks/column {"verticalAlign":"center"} -->
<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-center"><div class="c9-column-innner"><!-- wp:c9-blocks/heading {"heading":"Toggle-able Limitations","tagLevel":5} -->
...
<div style="text-align:left" class="c9-cta c9-block-cta container"><div class="row"><div class="c9-cta-content col-12 col-md-8"><div class="c9-cta-text" style="color:#ffffff;font-size:19px"><p><strong>Subscribe to our emails and we'll send you $50 in the mail. Don't believe us? Try me.</strong></p></div></div><div class="c9-cta-button col-12 col-md-4"><a href="#" target="_self" rel="noopener noreferrer" class="wp-block-button__link c9-button-shape-square c9-button-size-extralarge" style="color:#ffffff;background-color:#23cd34">SUbscribe</a></div></div></div>
