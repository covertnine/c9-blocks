export default {
  ...
  <div class="wp-block-group has-background" style="background-color:#fafafa"><!-- wp:c9-blocks/heading {"heading":"Email Us Directly","subheading":"Response time 24/7","addSubheading":true,"tagLevel":3} -->
  ...
  <!-- wp:paragraph -->
  <p class=""><strong>Phone</strong> 888-555-0000</p>
  <!-- /wp:paragraph -->
  ...
  <div class="wp-block-button aligncenter is-style-outline"><a class="wp-block-button__link wp-element-button" href="#">live chat now</a></div>
  <!-- /wp:button -->
  ...
  <!-- wp:c9-blocks/grid {"instanceId":2,"containerHue":"#f4f4f4","minScreenHeight":30,"containerPadding":{"linked":true,"top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"},"className":"p-3"} -->
  <div class="c9-grid p-3 p-5 c9-scroll" style="min-height:30vh;background-color:rgba(244,244,244,1)"><!-- wp:c9-blocks/column-container {"align":"narrow","columns":2,"layout":"c9-2-col-equal","containerWidth":"container-narrow","verticalAlign":"center","overlayHue":"#ffffff","containerMargin":{"linked":true,"top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"},"containerPadding":{"linked":true,"top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"}} -->
  <div class="container-narrow c9-column-container c9-scroll c9-layout-columns-2 c9-is-vertically-aligned-center c9-2-col-equal" style="min-height:10vh"><div class="c9-overlay-container" style="background-color:rgba(255,255,255,1);mix-blend-mode:normal"></div><div class="c9-layout-column-wrap c9-block-layout-column-gap-2 c9-is-responsive-column"><!-- wp:c9-blocks/column {"verticalAlign":"center"} -->
  ...
  <p class="has-text-align-center"><strong>Headquarters</strong><br>100 N. Main St.<br>Suite 200<br>Chicago, IL</p>
