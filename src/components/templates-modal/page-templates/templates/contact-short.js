export default {
  ...
  <div class="c9-grid p-5 p-3 c9-scroll c9-grid-has-background" style="min-height:27vh;background-color:rgba(63,63,63,1)"><!-- wp:c9-blocks/column-container {"columns":1,"layout":"one-column","verticalAlign":"center","minScreenHeight":0} -->
  ...
  <div class="c9-grid p-5 p-3 c9-scroll" style="min-height:20vh"><!-- wp:c9-blocks/column-container {"columns":2,"columnsGap":6,"layout":"c9-2-col-wideleft","minScreenHeight":0,"containerMargin":{"linked":false,"top":"5","bottom":"-1","left":"-1","right":"-1","icon":"editor-unlink"},"containerPadding":{"linked":true,"top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"}} -->
