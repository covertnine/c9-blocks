export default {
	...
	<div class="c9-grid p-5 p-3 c9-scroll c9-grid-has-background" style="min-height:85vh"><!-- wp:c9-blocks/column-container {"columns":2,"layout":"c9-2-col-wideleft","verticalAlign":"center","minScreenHeight":0} -->
	...
	<!-- wp:c9-blocks/heading {"heading":"Change the background image by selecting on the outer container known as the \u003cstrong\u003eC9 Grid\u003c/strong\u003e. Backgrounds can be videos, colors, photos, or a combination of all of the above.","tagLevel":3,"displayLevel":"6","type":"c9-sh subhead-h","textColor":"#ffffff","weight":"light","overrideStyle":true} -->
	<div class="section-heading c9-heading text-left"><h3 class="c9-sh subhead-h6 font-weight-light" style="color:#ffffff">Change the background image by selecting on the outer container known as the <strong>C9 Grid</strong>. Backgrounds can be videos, colors, photos, or a combination of all of the above.</h3></div>
	<!-- /wp:c9-blocks/heading -->
	...
	<div class="container c9-column-container c9-scroll c9-layout-columns-2 c9-2-col-equal"><div class="c9-overlay-container" style="background-color:rgba(255,255,255,1);mix-blend-mode:overlay"></div><div class="c9-layout-column-wrap c9-block-layout-column-gap-2 c9-is-responsive-column"><!-- wp:c9-blocks/column -->
	...
	<!-- wp:paragraph {"style":{"color":{"text":"#282828"}},"fontSize":"normal"} -->
	<p class="has-text-color has-normal-font-size" style="color:#282828">Positioning of background imagery can be changed on mobile specific layout to change the orientation, size, scaling, or focal point so your content looks great on desktop screens.</p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-button"><a class="wp-block-button__link has-color-primary-background-color has-background wp-element-button" href="#">Button Link</a></div>
	<!-- /wp:button --></div>
	<!-- /wp:group --></div></div>
	<!-- /wp:c9-blocks/column -->
	...
	<div class="c9-grid p-5 p-3 c9-scroll" style="min-height:20vh;background-color:rgba(234,234,234,1)"><!-- wp:c9-blocks/column-container {"columns":1,"layout":"one-column","verticalAlign":"center","minScreenHeight":0} -->
	...
	<div style="text-align:left" class="c9-cta c9-block-cta container p-5"><div class="row"><div class="c9-cta-content col-12 col-md-9"><div class="c9-cta-text c9-h" style="font-size:2.5rem"><p>Get the insiders list for all of our best content in your inbox. Each week.</p></div></div><div class="c9-cta-button col-12 col-md-3"><a href="#" target="_self" rel="noopener noreferrer" class="wp-block-button__link c9-button-shape-square c9-button-size-extralarge" style="color:#ffffff">Sign up</a></div></div></div>
