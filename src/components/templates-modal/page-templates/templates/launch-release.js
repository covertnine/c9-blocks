...
<!-- wp:button {"style":{"color":{"background":"#1abe61"}},"textColor":"very-light-gray","align":"center","className":"is-style-default"} -->
<div class="wp-block-button aligncenter is-style-default"><a class="wp-block-button__link has-very-light-gray-color has-text-color has-background" href="#" style="background-color:#1abe61">stream NOW</a></div>
<!-- /wp:button --></div></div>
...
<!-- wp:c9-blocks/grid {"instanceId":2,"rows":2,"containerImgURL":"https://c9.covertnine.com/wp-content/uploads/2020/09/20190622-disney-alaska-vacation-66-2.jpg","containerHue":"#f4f4f4","overlayHue":"#232323","overlayOpacity":1,"blendMode":"normal","minScreenHeight":60,"containerMargin":{"linked":true,"unit":"px","top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"}} -->
