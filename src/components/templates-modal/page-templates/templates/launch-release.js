...
export default {
	...
	<div class="c9-grid p-5 c9-scroll c9-grid-has-background c9-grid-has-video" style="min-height:84vh;background-color:rgba(49,49,49,1)"><!-- wp:c9-blocks/column-container {"align":"wide","columns":2,"columnsGap":1,"layout":"c9-2-col-wideleft","verticalAlign":"center","minScreenHeight":34} -->
	...
	<!-- wp:c9-blocks/grid {"instanceId":1,"rows":2,"containerImgURL":"https://cortex.covertnine.com/wp-content/uploads/2018/03/neonbrand-271745-unsplash-e1521416335547.jpg","overlayHue":"#000000","overlayOpacity":4,"blendMode":"normal","minScreenHeight":10,"containerMargin":{"linked":true,"unit":"px","top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"},"containerPadding":{"linked":true,"top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"},"focalPointMobile":{"x":0.75,"y":0.5},"overrideMobile":true} -->
	...
	<!-- wp:c9-blocks/heading {"heading":"Stream Discography","subheading":"anyway you want it that's the way you want it","addSubheading":true,"tagLevel":3,"displayLevel":"2","textColor":"#ffffff","subTextColor":"#d0d0d0","textAlign":"center","overrideStyle":true} -->
	<div class="section-heading c9-heading text-center"><h3 class="c9-h h2" style="color:#ffffff">Stream Discography</h3><div class="c9-h h2"><small class="text-muted" style="color:#d0d0d0">&nbsp;anyway you want it that's the way you want it</small></div></div>
	<!-- /wp:c9-blocks/heading --></div></div>
	<!-- /wp:c9-blocks/column --></div></div>
	...
	<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-top"><div class="c9-column-innner"><!-- wp:image {"id":472,"width":323,"height":323,"className":"img-fluid"} -->
	<figure class="wp-block-image is-resized img-fluid"><img src="https://cortex.covertnine.com/wp-content/uploads/2019/10/fake-album-3-768x768.jpg" alt="" class="wp-image-472" width="323" height="323"/></figure>
	<!-- /wp:image -->
	...
	<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-top"><div class="c9-column-innner"><!-- wp:image {"id":471,"width":322,"height":322,"className":"img-fluid"} -->
	<figure class="wp-block-image is-resized img-fluid"><img src="https://cortex.covertnine.com/wp-content/uploads/2019/10/fake-album-2-768x768.jpg" alt="" class="wp-image-471" width="322" height="322"/></figure>
	<!-- /wp:image -->
	...
	<!-- wp:c9-blocks/column {"verticalAlign":"top"} -->
	<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-top"><div class="c9-column-innner"><!-- wp:image {"id":470,"width":319,"height":319,"className":"img-fluid"} -->
	<figure class="wp-block-image is-resized img-fluid"><img src="https://cortex.covertnine.com/wp-content/uploads/2019/10/fake-album-1-768x768.jpg" alt="" class="wp-image-470" width="319" height="319"/></figure>
	<!-- /wp:image -->
	...
	<!-- /wp:core-embed/spotify --></div></div>
	<!-- /wp:c9-blocks/column --></div></div>
	<!-- /wp:c9-blocks/column-container --><div class="c9-overlay-container" style="background-color:rgba(0,0,0,.4);mix-blend-mode:normal"></div><div class="c9-image-container c9-image-mobile-center-right c9-image-mobile-size-cover" style="background-position:50% 50%;background-image:url(https://cortex.covertnine.com/wp-content/uploads/2018/03/neonbrand-271745-unsplash-e1521416335547.jpg);background-repeat:no-repeat;background-size:cover"></div></div>
	<!-- /wp:c9-blocks/grid -->
	...
	<!-- wp:c9-blocks/grid {"instanceId":3,"containerImgURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/anton-malanin-q323Yb-9Pu8-unsplash.jpg","containerHue":"#000000","overlayHue":"#000000","overlayOpacity":9,"blendMode":"multiply","minScreenHeight":90} -->
	<div class="c9-grid p-5 c9-scroll c9-grid-has-background" style="min-height:90vh;background-color:rgba(0,0,0,1)"><!-- wp:c9-blocks/column-container {"align":"narrow","columns":1,"layout":"one-column","containerWidth":"container-narrow","verticalAlign":"center"} -->
	...
	<div class="c9-block-layout-column c9-column text-center"><div class="c9-column-innner"><!-- wp:c9-blocks/image-carousel {"instanceId":0,"url":["//cortex.covertnine.com/wp-content/uploads/2019/08/adult-applause-audience-625644-web-1024x682.jpg","//cortex.covertnine.com/wp-content/uploads/2019/08/concert-crowd-dancing-1540338-web2-1024x682.jpg","//cortex.covertnine.com/wp-content/uploads/2019/08/audience-backlit-band-154147-web-1024x682.jpg"],"id":[7535,7536,7534],"captionTitle":["Image Caption","No Caption","Now this is podcracing!"],"captionContent":["Optional Image Subheading Below","No Comment",null],"isResponsive":true,"slideMaxHeight":600,"slideEqualHeight":true,"verticalAlign":"center"} -->
	<div id="c9-image-carousel-indicator-0" class="c9-image-carousel carousel slide" data-ride="carousel" data-interval="5000" data-wrap="true" style="height:600px"><ol class="carousel-indicators"><li data-target="#c9-image-carousel-indicator-0" data-slide-to="0" class="active"></li><li data-target="#c9-image-carousel-indicator-0" data-slide-to="1"></li><li data-target="#c9-image-carousel-indicator-0" data-slide-to="2"></li></ol><div class="carousel-inner c9-is-vertically-aligned-center"><div class="carousel-item active"><img src="//cortex.covertnine.com/wp-content/uploads/2019/08/adult-applause-audience-625644-web-1024x682.jpg" class="d-block w-100 wp-image-7535"/><div class="carousel-caption d-none d-md-block"><h5>Image Caption</h5><p>Optional Image Subheading Below</p></div></div><div class="carousel-item"><img src="//cortex.covertnine.com/wp-content/uploads/2019/08/concert-crowd-dancing-1540338-web2-1024x682.jpg" class="d-block w-100 wp-image-7536"/><div class="carousel-caption d-none d-md-block"><h5>No Caption</h5><p>No Comment</p></div></div><div class="carousel-item"><img src="//cortex.covertnine.com/wp-content/uploads/2019/08/audience-backlit-band-154147-web-1024x682.jpg" class="d-block w-100 wp-image-7534"/><div class="carousel-caption d-none d-md-block"><h5>Now this is podcracing!</h5></div></div></div><a class="carousel-control-prev" href="#c9-image-carousel-indicator-0" role="button" data-slide="prev"><span class="carousel-control-prev-icon" aria-hidden="true"></span><span class="sr-only">Previous</span></a><a class="carousel-control-next" href="#c9-image-carousel-indicator-0" role="button" data-slide="next"><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="sr-only">Next</span></a></div>
	...
	<!-- wp:c9-blocks/grid {"instanceId":4,"containerImgURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/gutenberg-event-page-template-band.jpg","overlayHue":"#cf2e2e","blendMode":"multiply","minScreenHeight":85,"containerMargin":{"linked":false,"unit":"px","top":"5","bottom":"-1","left":"5","right":"5","icon":"editor-unlink"},"focalPoint":{"x":0.4700460829493088,"y":0.3541666666666667},"focalPointMobile":{"x":0.5,"y":0.25},"overrideMobile":true} -->
	<div class="c9-grid p-5 mt-5 c9-scroll c9-grid-has-background" style="min-height:85vh"><!-- wp:c9-blocks/column-container {"columns":2,"layout":"c9-2-col-wideleft","verticalAlign":"bottom","overlayHue":"#ffffff","overlayOpacity":10,"minScreenHeight":5,"containerMargin":{"linked":false,"top":"-1","bottom":"5","left":"5","right":"5","icon":"editor-unlink"},"containerPadding":{"linked":true,"top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"}} -->
	...
	<!-- /wp:button --></div></div>
	<!-- /wp:c9-blocks/column --></div></div>
	<!-- /wp:c9-blocks/column-container --><div class="c9-overlay-container" style="background-color:rgba(207,46,46,.5);mix-blend-mode:multiply"></div><div class="c9-image-container c9-image-mobile-top-center c9-image-mobile-size-cover" style="background-position:47.004608294930875% 35.41666666666667%;background-image:url(//cortex.covertnine.com/wp-content/uploads/2019/08/gutenberg-event-page-template-band.jpg);background-repeat:no-repeat;background-size:cover"></div></div>
	<!-- /wp:c9-blocks/grid -->

	<!-- wp:c9-blocks/grid {"instanceId":5,"containerImgURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/candice-picard-mqSLs9mKIOc-unsplash.jpg","overlayOpacity":4,"blendMode":"multiply","minScreenHeight":75,"containerMargin":{"linked":true,"unit":"px","top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"},"focalPoint":{"x":0.5299539170506913,"y":0.4236111111111111}} -->
	<div class="c9-grid p-5 c9-scroll c9-grid-has-background" style="min-height:75vh"><!-- wp:c9-blocks/column-container {"columns":2,"layout":"c9-2-col-wideleft","verticalAlign":"top"} -->
