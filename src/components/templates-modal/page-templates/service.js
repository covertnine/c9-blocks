import Icon from "./page-icons/service.svg";
...
export default {
	...
	<div class="wp-block-button is-style-default"><a class="wp-block-button__link" href="#">Schedule Now</a></div>
	<!-- /wp:button --></div></div>
	<!-- /wp:c9-blocks/column -->
	...
	<!-- wp:c9-blocks/grid {"instanceId":14,"containerHue":"#363636","minScreenHeight":10,"containerPadding":{"linked":true,"top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"}} -->
	...
	<div style="text-align:right" class="c9-cta c9-block-cta container p-5"><div class="row"><div class="c9-cta-content col-12 col-md-9"><div class="c9-cta-text c9-sh" style="color:#eeeeee"><p>Watch our video walk through to get a guided tour.</p></div></div><div class="c9-cta-button col-12 col-md-3"><a href="#" target="_blank" rel="noopener noreferrer" class="wp-block-button__link c9-button-shape-outline c9-button-size-large" style="color:#00d084">Watch Video<span class="sr-only">(Link opens in new window)</span></a></div></div></div>
	...
	<!-- wp:button {"customTextColor":"#ffffff","className":"is-style-default"} -->
	<div class="wp-block-button is-style-default"><a class="wp-block-button__link has-text-color" href="#" style="color:#ffffff">Get Started</a></div>
	<!-- /wp:button --></div></div>
	<!-- /wp:c9-blocks/column -->
