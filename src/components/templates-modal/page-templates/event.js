import Icon from "./page-icons/event.svg";
...
export default {
	...
	<!-- wp:button {"textColor":"vivid-green-cyan","align":"center","className":"is-style-default"} -->
	<div class="wp-block-button aligncenter is-style-default"><a class="wp-block-button__link has-text-color has-vivid-green-cyan-color" href="#">get tickets</a></div>
	<!-- /wp:button --></div></div>
	<!-- /wp:c9-blocks/column -->
	
	<!-- wp:c9-blocks/column {"verticalAlign":"center"} -->
	<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-center"><div class="c9-column-innner"><!-- wp:image {"align":"center","width":150,"height":127} -->
	<div class="wp-block-image"><figure class="aligncenter is-resized"><img src="//cortex.covertnine.com/wp-content/uploads/2019/08/C9-RECORDS-placeholder.png" alt="" width="150" height="127"/></figure></div>
	<!-- /wp:image --></div></div>
	...
	<div class="c9-grid p-5 c9-scroll" style="min-height:50vh"><!-- wp:c9-blocks/column-container {"align":"narrow","columns":2,"layout":"c9-2-col-equal","containerWidth":"container-narrow","verticalAlign":"center"} -->
	<div class="container-narrow c9-column-container c9-scroll c9-layout-columns-2 c9-is-vertically-aligned-center c9-2-col-equal"><div class="c9-layout-column-wrap c9-block-layout-column-gap-2 c9-is-responsive-column"><!-- wp:c9-blocks/column {"verticalAlign":"top"} -->
