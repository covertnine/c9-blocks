import Icon from "../../../../../assets/section-template-icons/streaming-audio-preview.svg";

export default {
	icon: Icon,
	title: "Streaming Audio Preview",
	markup: `<!-- wp:c9-blocks/grid {"instanceId":3,"rows":2,"containerImgURL":"https://cortex.covertnine.com/wp-content/uploads/2018/03/neonbrand-271745-unsplash-e1521416335547.jpg","overlayHue":"#000000","overlayOpacity":4,"blendMode":"normal","minScreenHeight":10,"containerMargin":{"linked":true,"unit":"px","top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"},"containerPadding":{"linked":true,"top":"-1","bottom":"-1","left":"-1","right":"-1","icon":"admin-links"},"focalPointMobile":{"x":0.75,"y":0.5},"overrideMobile":true} -->
<div class="c9-grid my-5 c9-scroll c9-grid-has-background" style="min-height:10vh"><!-- wp:c9-blocks/column-container {"columns":1,"layout":"one-column"} -->
...
<figure class="wp-block-image is-resized img-fluid"><img src="http://cortex.covertnine.com/wp-content/uploads/2019/10/fake-album-2-768x768.jpg" alt="" class="wp-image-471" width="322" height="322"/></figure>
<!-- /wp:image -->
...
<!-- wp:c9-blocks/column {"verticalAlign":"top"} -->
<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-top"><div class="c9-column-innner"><!-- wp:image {"id":470,"width":323,"height":327,"className":"img-fluid"} -->
<figure class="wp-block-image is-resized img-fluid"><img src="http://cortex.covertnine.com/wp-content/uploads/2019/10/fake-album-1-768x768.jpg" alt="" class="wp-image-470" width="323" height="327"/></figure>
<!-- /wp:image -->
