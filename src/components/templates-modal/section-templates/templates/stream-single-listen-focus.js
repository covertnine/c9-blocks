export default {
	...
	markup: `<!-- wp:c9-blocks/grid {"instanceId":5,"containerImgURL":"https://c9.covertnine.com/wp-content/uploads/2020/09/20190622-disney-alaska-vacation-66-2.jpg","overlayHue":"#1d1d1d","overlayOpacity":7,"minScreenHeight":100,"focalPoint":{"x":"0.54","y":"1.00"}} -->
	...
	<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-center"><div class="c9-column-innner"><!-- wp:group {"layout":{"type":"constrained"},"c9PaddingSpaceSettings":{"linked":false,"icon":"editor-unlink","top":"-1","bottom":"-1","left":"5","right":"5"}} -->
	<div class="wp-block-group px-5"><!-- wp:c9-blocks/heading {"heading":"Song Lyrics","tagLevel":3,"displayLevel":"3","type":"c9-txl display-","textColor":"#ffffff","overrideStyle":true} -->
	<div class="section-heading c9-heading text-left"><h3 class="c9-txl display-3" style="color:#ffffff">Song Lyrics</h3></div>
	<!-- /wp:c9-blocks/heading -->
