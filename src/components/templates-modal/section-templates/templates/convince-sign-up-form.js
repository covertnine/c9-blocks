export default {
	...
	<!-- wp:separator {"backgroundColor":"color-light"} -->
	<hr class="wp-block-separator has-text-color has-color-light-color has-alpha-channel-opacity has-color-light-background-color has-background"/>
	<!-- /wp:separator -->
	...
	<div class="wp-block-buttons mt-5"><!-- wp:button {"style":{"color":{"background":"#cb282b"}}} -->
	<div class="wp-block-button"><a class="wp-block-button__link has-background wp-element-button" href="#" style="background-color:#cb282b">Submit</a></div>
	<!-- /wp:button --></div>
	<!-- /wp:buttons --></div>
	<!-- /wp:group --></div></div>
