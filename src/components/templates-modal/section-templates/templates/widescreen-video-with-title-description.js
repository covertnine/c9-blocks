...
export default {
	...
	markup: `<!-- wp:c9-blocks/grid {"instanceId":1,"containerHue":"#000000","overlayHue":"#3d3d3d","overlayOpacity":9,"blendMode":"multiply","minScreenHeight":50,"containerVideoURL":"https://cortex.covertnine.com/wp-content/uploads/2019/10/Pexels-Videos-1333384.mp4"} -->
...
<p style="color:#ffffff" class="has-text-color">Click on the section's outer edge of the C9 Grid block to select it and changes its background overlay, imagery, or video. If you don't see a sidebar when clicking on the C9 Grid block, click the gear icon and then change Background Settings</p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:c9-blocks/column --></div></div>
<!-- /wp:c9-blocks/column-container --><div class="c9-overlay-container" style="background-color:rgba(61,61,61,.9);mix-blend-mode:multiply"></div><div class="c9-video-container d-none d-sm-block"><div class="c9-embed-container"><video id="containerVideo-1" class="c9-video-custom" playsinline autoplay muted loop style="min-height:50vh"><source src="https://cortex.covertnine.com/wp-content/uploads/2019/10/Pexels-Videos-1333384.mp4" type="video/mp4"/></video></div></div></div>
<!-- /wp:c9-blocks/grid -->`
};
