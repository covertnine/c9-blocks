...
<div class="wp-block-group has-color-light-background-color has-background"><div class="wp-block-group__inner-container"><!-- wp:c9-blocks/heading {"heading":"Section Title","tagLevel":5} -->
<div class="section-heading c9-heading text-left"><h5 class="c9-h">Section Title</h5></div>
<!-- /wp:c9-blocks/heading -->

<!-- wp:paragraph -->
<p>The agency is "embedded" in the code so your page layouts reflect your objectives for each page, while laying out nicely on screens of all shapes and sizes so content managers can focus on marketing.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>It's also 100% compatible with the WordPress Blocks API + FREE.</p>
<!-- /wp:paragraph -->
...
<!-- wp:image {"align":"center","id":3926,"width":60,"height":57,"sizeSlug":"large","linkDestination":"none"} -->
...
<!-- wp:image {"align":"center","id":3932,"width":56,"height":56,"sizeSlug":"large","linkDestination":"none"} -->
...
<!-- wp:image {"align":"center","id":3928,"width":56,"height":56,"sizeSlug":"large","linkDestination":"none"} -->
