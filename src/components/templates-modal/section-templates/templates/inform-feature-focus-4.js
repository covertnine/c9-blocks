export default {
	icon: (
		<img
			className="svg-img"
			src={`${c9_blocks_assets.asset_folder}/section-template-icons/inform-feature-focus-4.svg`}
		/>
	),
...
<div class="section-heading c9-heading text-left"><h4 class="c9-h">C9 Feature Highlight</h4></div>
<!-- /wp:c9-blocks/heading -->

<!-- wp:paragraph -->
<p>Bring complex landing pages to life in minutes from section + page templates or build pages from scratch using C9 Grid blocks on any C9 supported theme. </p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link">Download C9</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
<!-- /wp:group --></div></div>
<!-- /wp:c9-blocks/column -->
...
<!-- wp:image {"align":"center","id":3929,"width":56,"height":56,"sizeSlug":"large","linkDestination":"none"} -->
...
<!-- wp:image {"align":"center","id":3924,"width":62,"height":56,"sizeSlug":"large","linkDestination":"none"} -->
