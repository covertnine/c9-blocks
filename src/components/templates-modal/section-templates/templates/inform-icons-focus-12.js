export default {
	icon: (
		<img
			className="svg-img"
			src={`${c9_blocks_assets.asset_folder}/section-template-icons/inform-icons-focus-12.svg`}
		/>
	),
...
<!-- wp:c9-blocks/heading {"heading":"Fan Spotlight","tagLevel":6,"textAlign":"center"} -->
<div class="section-heading c9-heading text-center"><h6 class="c9-h">Fan Spotlight</h6></div>
...
<!-- wp:c9-blocks/heading {"heading":"Listen Music","tagLevel":6,"textAlign":"center"} -->
<div class="section-heading c9-heading text-center"><h6 class="c9-h">Listen Music</h6></div>
<!-- /wp:c9-blocks/heading --></div></div>
<!-- /wp:c9-blocks/column -->
