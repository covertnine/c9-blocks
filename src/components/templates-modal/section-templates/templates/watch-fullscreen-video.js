export default {
	...
	markup: `<!-- wp:c9-blocks/grid {"instanceId":0,"containerHue":"#000000","overlayHue":"#000000","overlayOpacity":8,"minScreenHeight":60,"containerVideoURL":"https://c9.covertnine.com/wp-content/uploads/2020/10/c9-website-2019-bg.mp4"} -->
	<div class="c9-grid p-3 c9-scroll c9-grid-has-video" style="min-height:60vh;background-color:rgba(0,0,0,1)"><!-- wp:c9-blocks/column-container {"columns":2,"layout":"c9-2-col-wideright","verticalAlign":"center","minScreenHeight":0,"containerMargin":{"linked":true,"top":"5","bottom":"5","left":"5","right":"5","icon":"admin-links"},"containerPadding":{"linked":false,"icon":"editor-unlink","top":"5","bottom":"5","left":"-1","right":"-1"}} -->
	<div class="container c9-column-container py-5 my-5 c9-scroll c9-layout-columns-2 c9-is-vertically-aligned-center c9-2-col-wideright"><div class="c9-layout-column-wrap c9-block-layout-column-gap-2 c9-is-responsive-column"><!-- wp:c9-blocks/column -->
	...
	<!-- wp:separator {"opacity":"css","style":{"color":{"background":"#f8f8f8"}}} -->
	<hr class="wp-block-separator has-text-color has-css-opacity has-background" style="background-color:#f8f8f8;color:#f8f8f8"/>
	<!-- /wp:separator -->
	
	<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
	<div class="wp-block-buttons"><!-- wp:button {"style":{"color":{"text":"#f9f9f9"}},"className":"is-style-default is-style-outline"} -->
	<div class="wp-block-button is-style-default is-style-outline"><a class="wp-block-button__link has-text-color wp-element-button" href="https://www.youtube.com/watch?v=zq6sgA1tmoQ" style="color:#f9f9f9">View Fullscreen Video</a></div>
	<!-- /wp:button --></div>
	<!-- /wp:buttons --></div></div>
	<!-- /wp:c9-blocks/column --></div></div>
	<!-- /wp:c9-blocks/column-container --><div class="c9-overlay-container" style="background-color:rgba(0,0,0,.8);mix-blend-mode:normal"></div><div class="c9-video-container d-none d-sm-block"><div class="c9-embed-container"><video id="containerVideo-0" class="c9-video-custom" playsinline autoplay muted loop style="min-height:60vh"><source src="https://c9.covertnine.com/wp-content/uploads/2020/10/c9-website-2019-bg.mp4" type="video/mp4"/></video></div></div></div>
	<!-- /wp:c9-blocks/grid -->`,
};
