...
export default {
	icon: Icon,
	title: "Large Audio Embed + Fullscreen Photo",
	markup: `<!-- wp:c9-blocks/grid {"instanceId":4,"containerImgURL":"//cortex.covertnine.com/wp-content/uploads/2019/08/audience-backlit-band-154147-web.jpg","overlayHue":"#00d084","blendMode":"normal","minScreenHeight":70} -->
...
<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-center"><div class="c9-column-innner"><!-- wp:image {"align":"center","width":132,"height":98} -->
<div class="wp-block-image"><figure class="aligncenter is-resized"><img src="//cortex.covertnine.com/wp-content/uploads/2019/08/feather-logo-white.png" alt="" width="132" height="98"/></figure></div>
<!-- /wp:image --></div></div>
