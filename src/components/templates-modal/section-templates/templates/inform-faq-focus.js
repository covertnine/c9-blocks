...
<div class="c9-block-layout-column c9-column text-left"><div class="c9-column-innner"><!-- wp:image {"id":3142,"width":358,"height":536,"sizeSlug":"large","linkDestination":"media"} -->
<figure class="wp-block-image size-large is-resized"><a href="https://c9.covertnine.com/wp-content/uploads/2020/10/c9-event-placeholder-flyer.jpg"><img src="https://c9.covertnine.com/wp-content/uploads/2020/10/c9-event-placeholder-flyer-683x1024.jpg" alt="" class="wp-image-3142" width="358" height="536"/></a></figure>
<!-- /wp:image --></div></div>
<!-- /wp:c9-blocks/column -->

<!-- wp:c9-blocks/column {"verticalAlign":"center"} -->
<div class="c9-block-layout-column c9-column text-left c9-is-vertically-aligned-center"><div class="c9-column-innner"><!-- wp:c9-blocks/heading {"heading":"Venue Limitations","tagLevel":5,"displayLevel":"4","type":"c9-txl display-","overrideStyle":true} -->
<div class="section-heading c9-heading text-left"><h5 class="c9-txl display-4">Venue Limitations</h5></div>
