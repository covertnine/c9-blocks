...
registerBlockType( 'covertnine-blocks/cortex-cta', {
	title: __( 'AB Call To Action', 'covertnine-blocks' ),
	description: __( 'Add a call to action section with a title, text, and a button.', 'covertnine-blocks' ),
	icon: 'megaphone',
