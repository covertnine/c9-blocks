...
export default class Inspector extends Component {
	...
	render() {
		...
		const imageCropOptions = [
			{ value: 'landscape', label: __( 'Landscape', 'covertnine-blocks' ) },
			{ value: 'square', label: __( 'Square', 'covertnine-blocks' ) },
		];

		// Post type options
		const postTypeOptions = [
			{ value: 'post', label: __( 'Post', 'covertnine-blocks' ) },
			{ value: 'page', label: __( 'Page', 'covertnine-blocks' ) },
		];

		// Section title tags
		const sectionTags = [
			{ value: 'div', label: __( 'div', 'covertnine-blocks' ) },
			{ value: 'header', label: __( 'header', 'covertnine-blocks' ) },
			{ value: 'section', label: __( 'section', 'covertnine-blocks' ) },
			{ value: 'article', label: __( 'article', 'covertnine-blocks' ) },
			{ value: 'main', label: __( 'main', 'covertnine-blocks' ) },
			{ value: 'aside', label: __( 'aside', 'covertnine-blocks' ) },
			{ value: 'footer', label: __( 'footer', 'covertnine-blocks' ) },
		];

		// Section title tags
		const sectionTitleTags = [
			{ value: 'h2', label: __( 'H2', 'covertnine-blocks' ) },
			{ value: 'h3', label: __( 'H3', 'covertnine-blocks' ) },
			{ value: 'h4', label: __( 'H4', 'covertnine-blocks' ) },
			{ value: 'h5', label: __( 'H5', 'covertnine-blocks' ) },
			{ value: 'h6', label: __( 'H6', 'covertnine-blocks' ) },
		];
		...
		return (
			<InspectorControls>
				<PanelBody
					title={ __( 'Post and Page Grid Settings', 'covertnine-blocks' ) }
					className={ isPost ? null : 'covertnine-blocks-hide-query' }
				>
					<SelectControl
						label={ __( 'Content Type', 'covertnine-blocks' ) }
					...
					/>
					<RangeControl
						label={ __( 'Number of items to offset', 'covertnine-blocks' ) }
					...
					{ attributes.postLayout === 'grid' &&
						<RangeControl
							label={ __( 'Columns', 'covertnine-blocks' ) }
				...
				<PanelBody
					title={ __( 'Post and Page Grid Content', 'covertnine-blocks' ) }
					initialOpen={ false }
				>
					<ToggleControl
						label={ __( 'Display Section Title', 'covertnine-blocks' ) }
					...
					{ attributes.displaySectionTitle &&
						<TextControl
							label={ __( 'Section Title', 'covertnine-blocks' ) }
							type="text"
					...
					{ attributes.displayPostImage &&
						<Fragment>
							<SelectControl
								label={ __( 'Featured Image Style', 'covertnine-blocks' ) }
				...
				<PanelBody
					title={ __( 'Post and Page Grid Markup', 'covertnine-blocks' ) }
					initialOpen={ false }
					className="ab-block-post-grid-markup-settings"
				>
					<SelectControl
						label={ __( 'Post Grid Section Tag', 'covertnine-blocks' ) }
						options={ sectionTags }
						value={ attributes.sectionTag }
						onChange={ ( value ) => this.props.setAttributes( { sectionTag: value } ) }
						help={ __( 'Change the post grid section tag to match your content hierarchy.', 'covertnine-blocks' ) }
					/>
					{ attributes.sectionTitle &&
						<SelectControl
							label={ __( 'Section Title Heading Tag', 'covertnine-blocks' ) }
							options={ sectionTitleTags }
							value={ attributes.sectionTitleTag }
							onChange={ ( value ) => this.props.setAttributes( { sectionTitleTag: value } ) }
							help={ __( 'Change the post/page section title tag to match your content hierarchy.', 'covertnine-blocks' ) }
						/>
					}
					{ attributes.displayPostTitle &&
						<SelectControl
							label={ __( 'Post Title Heading Tag', 'covertnine-blocks' ) }
							options={ sectionTitleTags }
							value={ attributes.postTitleTag }
							onChange={ ( value ) => this.props.setAttributes( { postTitleTag: value } ) }
							help={ __( 'Change the post/page title tag to match your content hierarchy.', 'covertnine-blocks' ) }
						/>
					}
				</PanelBody>
			</InspectorControls>
