...
const logo = (
	<SVG xmlns="http://www.w3.org/2000/svg" viewBox="0 0 234.92 174.65">
		<defs>
			...
			>
				<stop offset="0" stopColor="#61cae5" />
				<stop offset="0.12" stopColor="#64c6e1" />
				<stop offset="0.25" stopColor="#6dbad3" />
				<stop offset="0.39" stopColor="#7ba7bd" />
				<stop offset="0.54" stopColor="#8f8b9f" />
				<stop offset="0.68" stopColor="#a96877" />
				<stop offset="0.83" stopColor="#c93d48" />
				<stop offset="0.92" stopColor="#df1f26" />
			</linearGradient>
		</defs>
		<title>c9-feather-logo-icon</title>
